...
| katana |create a image separator line katana hashira,would it be possible to remove the banner and just leave the image of the katana with a white background,make the background transparent|
